...
- [x] Add printing buttom to the screen where the "otra foto" button is show.
...
To the right of the printing button show a counter of the number of prints left.
If the counter is tapped show a pop up saying "Este es the número de impresiones restantes."

When the printing button is taped show a floating menu asking for number of copies,
